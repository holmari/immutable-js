...
(function (global, factory) {
  ...
  (factory((global.Immutable = {}),global.equal));
  ...
  function is(valueA, valueB) {
    ...
    var aIsValueObject = isValueObject(valueA);
    var bIsValueObject = isValueObject(valueB);
  ...
  function getDeepHashJSObj(obj, objPath) {
    ...
    var newPath = objPath.concat( [obj]);
  ...
  var version = "4.0.0-rc.12-alloy-1";
